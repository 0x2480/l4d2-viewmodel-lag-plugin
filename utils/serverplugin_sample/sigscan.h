...
public:
    ...
    static bool SetDllMemInfo(const char*);
	static bool MemSet(void* addr, int val, size_t len);
    static int GetModule() { return module_handle; };
    static int GetProcAddress(const char*);
