...
# How to run:
To load the plugin into your game client, put the dll into the "Left 4 Dead 2/bin" folder and run `plugin_load viewmodel_lag_plugin`.
To unload the plugin run `plugin_unload viewmodel_lag_plugin`
Running the plugin on a dedicated server, doesn't do anything - this plugin is made for the client only.

# How to build:
Clone the repository and open Everything_SDK-2005.sln with Visual Studio 2022 and compile.
